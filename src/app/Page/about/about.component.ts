...
export class AboutComponent {
  ...
  轉職到軟體產業，當代迅速發展的 AI可以是阻力，也可以是助力，而我更傾向於將它視為後者，AI詠唱師可以是一個職涯方向。     
  "喜歡工作，但不喜歡上班"，在從事軟體工作的期間，聽到這樣的心態敘述讓我更認識自己，會消滅熱情的不是工作，是上班。
  目前正朝著"數位游牧"的方向努力，如果你也在這條路上，我們可能是同溫層，希望我們都能盡早讓自己放手在世界各角落奔馳。\
  如果你是需要網頁相關的服務，或願意提供合作機會，可以透過下方資訊與我聯絡。我是 Noah~  
  `
